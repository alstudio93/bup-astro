  ...
  return (
    <div id="stylingWrapper" className="w-full shadow-md mb-5 p-4 fixed top-0 z-40 bg-white">
      <nav className="flex justify-between items-center w-full max-w-section mx-auto ">
        ...
        <ul className={` lg:flex gap-x-3  text-center font-[Nunito] font-normal ${open ? "flex flex-col  gap-y-8 fixed top-14 left-0 right-0 min-h-screen bg-[#ffffff] text-base pt-20 overflow-y-scroll" : "hidden text-sm"}`}>
          {
            Links.map((link) => (
              <div>
